...
with col1: 
    ...
    sepal_l = st.slider('Sepal Length (cm)', 1.0, 8.0, .5)
    sepal_w = st.slider('Sepal width (cm)', 1.0, 8.0, .5)

with col2:
    st.text('Petal Characteristics')
    petal_l = st.slider('Petal Length (cm)', 1.0, 8.0, .5)
    petal_w = st.slider('Petal width (cm)', 1.0, 8.0, .5)
